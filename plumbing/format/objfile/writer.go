...
// NewWriterWithFormat returns a new Writer using the given object format when
// computing the object hash.
func NewWriterWithFormat(w io.Writer, of format.ObjectFormat) *Writer {
	if of == format.UnsetObjectFormat {
		of = format.SHA1
	}
